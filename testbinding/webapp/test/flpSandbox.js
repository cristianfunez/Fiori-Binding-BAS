		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Prueba bindeo",
									"targetURL": "#ypftestbinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ypftestbinding-display": {
								"semanticObject": "ypftestbinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypf.testbinding",
									"url": sap.ui.require.toUrl("ypf/testbinding")
								}
							}
						}
					}
